...
@pytest.mark.parametrize(
    'k_max,p,dynamic_k,interest_extractor,add_pos',
    [(2, 1, False, 'sa', True), (1, 100, True, 'dr', False), (3, 50, True, 'dr', True),
     ]
)
def test_COMIREC(k_max, p, dynamic_k, interest_extractor, add_pos):
    model_name = "COMIREC"
    ...
    model = ComiRec(user_feature_columns, item_feature_columns, k_max=k_max, p=p, dynamic_k=dynamic_k,
